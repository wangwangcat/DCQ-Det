...
class InternImage(nn.Module):
    ...
    def forward(self, tensor_list: NestedTensor):
        ...
        # out:
        #   [P2:torch.Size([2, 192, 256, 256]), P3:torch.Size([2, 384, 128, 128]), \
        #    P4:torch.Size([2, 768, 64, 64]), P5:torch.Size([2, 1536, 32, 32])]
...
def build_intern_image(modelname, args):
    assert modelname in ['intern_T_22k', 'intern_L_22k', 'intern_XL_22k']

    model_para_dict = dict(
        core_op=args.core_op,
